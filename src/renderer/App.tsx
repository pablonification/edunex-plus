...
import { DashboardPanel, AgendaPanel, PresencePanel, TodoPanel } from "./features/feeds/feed-panels";
        ...
        >
          {showLogin ? (
            ...
            <>
              ...
              {activeKeyVisible !== "home" && activeKeyVisible !== "todo" && activeKeyVisible !== "agenda" && activeKeyVisible !== "presence" && (
